...
public class UserDTO {
    ...
    public UserDTO(Integer userId, String username, String userEmail, String userFirstName,
                   String userLastName, String userMobileNumber, String userStatus,
                   LocalDate userDob, String userGender, String userDepartment, String userHighestQualification, LocalDateTime userLastLogin) {
        this.userId = userId;
